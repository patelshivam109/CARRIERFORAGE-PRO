      ...
      <div className="container-sm" style={{ width: '100%', paddingTop: 40, paddingBottom: 40 }}>
        <div className="card fade-up" style={{ padding: 40 }}>
          <div style={{ textAlign: 'center', marginBottom: 32 }}>
            ...
            <p style={{ color: 'var(--text-secondary)', fontSize: 14 }}>Start building ATS-proof resumes for free</p>
          </div>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
            <div className="form-group">
              ...
              <div style={{ position: 'relative' }}>
                ...
                <input type="text" className="form-input" style={{ paddingLeft: 38 }} placeholder="Jane Smith"
            ...
            <div className="form-group">
              ...
              <div style={{ position: 'relative' }}>
                ...
                <input type={showPw ? 'text' : 'password'} className="form-input" style={{ paddingLeft: 38, paddingRight: 38 }}
